% function [Info, Result, WS_data] = HL_FP_Process_CW(ses_fn, baseline_fn, FP_ch_name)
...
[df_F_ds, ts_ds, df_F, F_baseline, FP_filter] = ...
    HL_FP_df_cw (ses_data.ch_data(:,idx_FP_ch), ses_data.ts, ses_data.sr, auto_baseline);
